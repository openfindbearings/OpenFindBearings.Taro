...
| v1.1.0 | 2026-09-03 | 决策修订 + 批次 1 实施 | 决策 1-7 + 新增 8-14（商家动态标题/天空蓝主色/图标反色/TabBar 加大/官方主题重构/实施顺序/系统字体）；批次 1 样式基础完成 |
| v1.2.0 | 2026-09-03 | 决策重申 + 批次 1-3 完成 | 重申"重写要多端支持，RN 不能再改不动"；批次 2 NavBar、批次 3 CustomTabBar 完成 |
...
| 批次 | 状态 | 内容 |
|------|------|------|
| 批次 4 | 待开始 | 5 个页面统一重构（首页/商家/我的/设置/搜索） |
